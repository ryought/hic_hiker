...
def main():
    ...
    # create scaf_to_ref
    # assign the most frequent ref_name, orientation
...
def calc_order(sorted_sam, scaf_to_ref):
    ...
    while n < N:
        ...
        # print(n, scaf_name, ref_name_of_scaf, chunk1, chunk2)
        # print(chunk1 == chunk2, chunk1[0] == chunk2[0], chunk1[0] == ref_name_of_scaf)
        if chunk1 == chunk2:
